type RuntimeEnvKey =
    ...
    | "NEXT_PUBLIC_INSTANCE_CONFIG"
    | "NEXT_PUBLIC_GROUP_REGISTRY"
    | "NEXT_PUBLIC_POLICY_GUARD_V2";
...
const BUILD_ENV: RuntimeEnvMap = {
    ...
    NEXT_PUBLIC_POLICY_REGISTRY: process.env.NEXT_PUBLIC_POLICY_REGISTRY,
    NEXT_PUBLIC_INSTANCE_CONFIG: process.env.NEXT_PUBLIC_INSTANCE_CONFIG,
    NEXT_PUBLIC_GROUP_REGISTRY: process.env.NEXT_PUBLIC_GROUP_REGISTRY,
    NEXT_PUBLIC_POLICY_GUARD_V2: process.env.NEXT_PUBLIC_POLICY_GUARD_V2,
};
